<div class="container">
	<h2>
		<?php echo __('EventType Manager: EventType (index)'); ?>
	</h2>
	<div class="row-fluid show-grid" id="tab_user_manager">
		...
		<?php echo $this->Html->link(__('New Event Type', true), array('plugin' => 'full_calendar', 'action' => 'admin_add'),array('class'=>'btn btn-mini btn-primary')); ?>
			...
			<table class="table table-bordered table-hover list table-condensed table-striped">
				<thead>
					<tr>
						...
						<th style="width: 30px;"><?php echo $this->Paginator->sort('color','Color'); ?>
						</th>
				...
				<tr>
					...
					<td style="text-align: center;">
						...
						<?php echo $this->html->link(__('View'), array('action' => 'admin_view', $eventType['EventType']['id']),array('class'=>'btn btn-mini')); ?>
						<?php echo $this->html->link(__('Edit'), array('action' => 'admin_edit', $eventType['EventType']['id']),array('class'=>'btn btn-mini btn-primary')); ?>
						<?php echo $this->html->link(__('delete'), array('action' => 'admin_delete', $eventType['EventType']['id']),array('class'=>'btn btn-mini btn-danger')); ?>
