...
<div class="col-xs-12 col-sm-9 col-sm9 col-lg-9">
    ...
    <h1 class=""><?php echo $title; ?></h1>
                      ...
                      <a class="" href="http://www.thunderbot.gg/membre/<?php echo $article['User']['id']; ?>">
                        ...
                        <?php echo h($article['Article']['redacteur']); ?></em></strong>
                      </p>
...
<?php foreach ($threearticles as $threearticle): ?>
  ...
  <img id="img_full" class="img-responsive" alt="<?php echo $threearticle['Article']['article_title']; ?>" src="http://www.thunderbot.gg/thumb.php?src=/files/article/photo/<?php echo $threearticle['Article']['photo_dir'] ?>/<?php echo $threearticle['Article']['photo'] ?>&w=270&h=166&zc=1"></img>
      </a>
              <div class="caption">
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
