	...
	<div class="navbar-inner">
		<div class="container">
			<ul class="nav pull-right">
				<li><a href="<?php echo $this->Html->url('polls/admin_add/#/edit_poll/0');?>"><i class="icon-plus"></i> Add</a></li>
			</ul>
		</div>
	</div>
</div>
<table cellpadding="0" cellspacing="0"  class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<td class="actions" style="text-align:center;">
			...
			<?php echo $this->Html->link(__('Statistic'), array('action' => 'admin_view', $poll['Poll']['id']), array('class'=>'btn btn-small')); ?>
			<a class="btn btn-small" href="<?php echo $this->Html->url('/polls/polls/admin_edit/'.$poll['Poll']['id'].'/#/edit_poll/'.$poll['Poll']['id']);?>"><?php echo __('Edit');?></a>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'admin_delete', $poll['Poll']['id']), array('class'=>'btn btn-small'), __('Are you sure you want to delete # %s?\n All data will be deleted. This action cannot be undone.', $poll['Poll']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
