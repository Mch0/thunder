...
<span class="float"> <?php echo $this->Html->link("Img en attente de validation",array('action'=>'admin_validate'),array('class'=>'btn btn-small btn-primary')); ?> </span>
</div>
		...
		<div class="span12">
			...
			<table class="table table-bordered table-hover list table-condensed table-striped">
				...
				<tr>
					...
					<td style="text-align: center;"><?php echo h($image['Image']['slug']); ?>&nbsp;
					</td>

					<td style="text-align: center;">		 <img class="image_index_full" src="http://www.thunderbot.gg/<?php echo $this->Html->url($image['Image']['image']); ?>" alt="">
					</td>
