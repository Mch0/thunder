<div id="single_video">
<?php 
$this->html->meta ('description',  $video['Video']['video_title'], array('inline' =>false));
?>
...
if ($comment['User']['avatar']) {
		echo $this->Html->image('/files/users/thumbnails/'.($comment['User']['id'].'_scale_150.jpg'), array('class' => 'thumb_blog'));
} else {
    echo $this->Html->image("/files/robotthunderbot.jpg", array("class" => "thumb_blog",));
}
?>
					            </div>
					            <div class="span10">
