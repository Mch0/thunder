...
?>
<?php echo "totot" ?>
<!-- Plugin/Article/View/ArticlePages/view.ctp -->
<div class="row-fluid">
    <div class="span12">
...
<div class="row-fluid">
    <div class="span8">
        ...
        <div class="article">
            ...
            <a class="title_thunder" href="/article/666-lcs-na-spring-2014-promotion-qualifier">
                <?php echo $this->
                html->image('/files/article/photo/'.($articlePage['ArticlePage']['photo_dir'].'/'.$articlePage['ArticlePage']['photo']),
                array('class' => 'thumb_blog')); ?>
            </a>
