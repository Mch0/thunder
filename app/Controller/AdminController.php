...
class AdminController extends AppController {
	...
	public function beforeFilter() {
		...
		$this->Auth->loginRedirect = array('controller' => 'articles', 'action' => 'index','plugin' => 'article');
		$this->Auth->logoutRedirect = array('controller' => 'articles', 'action' => 'index','plugin' => 'article');
